...
func handleNotificationTestCommand(cmd *NotificationTestCommand) error {
	...
	model := &m.AlertNotification{Name: cmd.Name, Type: cmd.Type, Settings: cmd.Settings}
...
func evalMatchesBasedOnState() []*EvalMatch {
	...
	matches = append(matches, &EvalMatch{Metric: "High value", Value: null.FloatFrom(100)})
	matches = append(matches, &EvalMatch{Metric: "Higher Value", Value: null.FloatFrom(200)})
	return matches
}
