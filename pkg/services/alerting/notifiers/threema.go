...
func (notifier *ThreemaNotifier) Notify(evalContext *alerting.EvalContext) error {
	...
	message := fmt.Sprintf("%s%s\n\n*State:* %s\n*Message:* %s\n", stateEmoji, evalContext.GetNotificationTitle(), evalContext.Rule.Name, evalContext.Rule.Message)
	...
	cmd := &m.SendWebhookSync{Url: url, Body: body, HttpMethod: "POST", HttpHeader: headers}
