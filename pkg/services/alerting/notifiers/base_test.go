...
func TestBaseNotifier(t *testing.T) {
	...
	Convey("default constructor for notifiers", t, func() {
		...
		model := &m.AlertNotification{Id: 1, Name: "name", Type: "email", Settings: bJson}
