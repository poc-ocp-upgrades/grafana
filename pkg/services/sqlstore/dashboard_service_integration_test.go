	...
	Convey("Dashboard service integration tests", t, func() {
		...
		Convey("Given saved folders and dashboards in organization A", func() {
			...
			Convey("When saving a dashboard with non-existing id", func() {
				cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": float64(123412321), "title": "Expect error"})}
			...
			Convey("Given organization B", func() {
				...
				Convey("When creating a dashboard with same id as dashboard in organization A", func() {
					cmd := models.SaveDashboardCommand{OrgId: otherOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInFolder.Id, "title": "Expect error"}), Overwrite: false}
					err := callSaveWithError(cmd)
					Convey("It should result in not found error", func() {
						So(err, ShouldNotBeNil)
						So(err, ShouldEqual, models.ErrDashboardNotFound)
				...
				permissionScenario("Given user has permission to save", true, func(sc *dashboardPermissionScenarioContext) {
					Convey("When creating a dashboard with same uid as dashboard in organization A", func() {
						var otherOrgId int64 = 2
						cmd := models.SaveDashboardCommand{OrgId: otherOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedDashInFolder.Uid, "title": "Dash with existing uid in other org"}), Overwrite: false}
			...
			permissionScenario("Given user has no permission to save", false, func(sc *dashboardPermissionScenarioContext) {
				Convey("When creating a new dashboard in the General folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": "Dash"}), UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
				...
				Convey("When creating a new dashboard in other folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": "Dash"}), FolderId: otherSavedFolder.Id, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
				...
				Convey("When creating a new dashboard by existing title in folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": savedDashInFolder.Title}), FolderId: savedFolder.Id, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
				...
				Convey("When creating a new dashboard by existing uid in folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedDashInFolder.Uid, "title": "New dash"}), FolderId: savedFolder.Id, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
					Convey("It should create dashboard guardian for folder with correct arguments and result in access denied error", func() {
						So(err, ShouldNotBeNil)
						So(err, ShouldEqual, models.ErrDashboardUpdateAccessDenied)
				...
				Convey("When updating a dashboard by existing id in the General folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInGeneralFolder.Id, "title": "Dash"}), FolderId: savedDashInGeneralFolder.FolderId, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
				...
				Convey("When updating a dashboard by existing id in other folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInFolder.Id, "title": "Dash"}), FolderId: savedDashInFolder.FolderId, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
					Convey("It should create dashboard guardian for dashboard with correct arguments and result in access denied error", func() {
						So(err, ShouldNotBeNil)
						So(err, ShouldEqual, models.ErrDashboardUpdateAccessDenied)
				...
				Convey("When moving a dashboard by existing id to other folder from General folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInGeneralFolder.Id, "title": "Dash"}), FolderId: otherSavedFolder.Id, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
				...
				Convey("When moving a dashboard by existing id to the General folder from other folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInFolder.Id, "title": "Dash"}), FolderId: 0, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
					Convey("It should create dashboard guardian for General folder with correct arguments and result in access denied error", func() {
						So(err, ShouldNotBeNil)
						So(err, ShouldEqual, models.ErrDashboardUpdateAccessDenied)
				...
				Convey("When moving a dashboard by existing uid to other folder from General folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedDashInGeneralFolder.Uid, "title": "Dash"}), FolderId: otherSavedFolder.Id, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
					Convey("It should create dashboard guardian for other folder with correct arguments and result in access denied error", func() {
						So(err, ShouldNotBeNil)
						So(err, ShouldEqual, models.ErrDashboardUpdateAccessDenied)
				...
				Convey("When moving a dashboard by existing uid to the General folder from other folder", func() {
					cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedDashInFolder.Uid, "title": "Dash"}), FolderId: 0, UserId: 10000, Overwrite: true}
					err := callSaveWithError(cmd)
					Convey("It should create dashboard guardian for General folder with correct arguments and result in access denied error", func() {
						So(err, ShouldNotBeNil)
						So(err, ShouldEqual, models.ErrDashboardUpdateAccessDenied)
			...
			permissionScenario("Given user has permission to save", true, func(sc *dashboardPermissionScenarioContext) {
				Convey("and overwrite flag is set to false", func() {
					...
					Convey("When creating a dashboard in General folder with same name as dashboard in other folder", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": nil, "title": savedDashInFolder.Title}), FolderId: 0, Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
					...
					Convey("When creating a dashboard in other folder with same name as dashboard in General folder", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": nil, "title": savedDashInGeneralFolder.Title}), FolderId: savedFolder.Id, Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
						Convey("It should create a new dashboard", func() {
					...
					Convey("When creating a folder with same name as dashboard in other folder", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": nil, "title": savedDashInFolder.Title}), IsFolder: true, Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
					...
					Convey("When saving a dashboard without id and uid and unique title in folder", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": "Dash without id and uid"}), Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
						Convey("It should create a new dashboard", func() {
					...
					Convey("When saving a dashboard when dashboard id is zero ", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": 0, "title": "Dash with zero id"}), Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
						Convey("It should create a new dashboard", func() {
							query := models.GetDashboardQuery{OrgId: cmd.OrgId, Id: res.Id}
					...
					Convey("When saving a dashboard in non-existing folder", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": "Expect error"}), FolderId: 123412321, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
					...
					Convey("When updating an existing dashboard by id without current version", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInGeneralFolder.Id, "title": "test dash 23"}), FolderId: savedFolder.Id, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
					...
					Convey("When updating an existing dashboard by id with current version", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInGeneralFolder.Id, "title": "Updated title", "version": savedDashInGeneralFolder.Version}), FolderId: savedFolder.Id, Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
					...
					Convey("When updating an existing dashboard by uid without current version", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedDashInFolder.Uid, "title": "test dash 23"}), FolderId: 0, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
						Convey("It should result in version mismatch error", func() {
							So(err, ShouldNotBeNil)
							So(err, ShouldEqual, models.ErrDashboardVersionMismatch)
					...
					Convey("When updating an existing dashboard by uid with current version", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedDashInFolder.Uid, "title": "Updated title", "version": savedDashInFolder.Version}), FolderId: 0, Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
						Convey("It should update dashboard", func() {
					...
					Convey("When creating a dashboard with same name as dashboard in other folder", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": nil, "title": savedDashInFolder.Title}), FolderId: savedDashInFolder.FolderId, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
					...
					Convey("When creating a dashboard with same name as dashboard in General folder", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": nil, "title": savedDashInGeneralFolder.Title}), FolderId: savedDashInGeneralFolder.FolderId, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
						Convey("It should result in dashboard with same name in folder error", func() {
							So(err, ShouldNotBeNil)
							So(err, ShouldEqual, models.ErrDashboardWithSameNameInFolderExists)
					...
					Convey("When creating a folder with same name as existing folder", func() {
						cmd := models.SaveDashboardCommand{OrgId: testOrgId, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": nil, "title": savedFolder.Title}), IsFolder: true, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
						Convey("It should result in dashboard with same name in folder error", func() {
							So(err, ShouldNotBeNil)
							So(err, ShouldEqual, models.ErrDashboardWithSameNameInFolderExists)
				...
				Convey("and overwrite flag is set to true", func() {
					...
					Convey("When updating an existing dashboard by id without current version", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInGeneralFolder.Id, "title": "Updated title"}), FolderId: savedFolder.Id, Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
						Convey("It should update dashboard", func() {
							query := models.GetDashboardQuery{OrgId: cmd.OrgId, Id: savedDashInGeneralFolder.Id}
					...
					Convey("When updating an existing dashboard by uid without current version", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedDashInFolder.Uid, "title": "Updated title"}), FolderId: 0, Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						So(res, ShouldNotBeNil)
						Convey("It should update dashboard", func() {
							query := models.GetDashboardQuery{OrgId: cmd.OrgId, Id: savedDashInFolder.Id}
					...
					Convey("When updating uid for existing dashboard using id", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInFolder.Id, "uid": "new-uid", "title": savedDashInFolder.Title}), Overwrite: shouldOverwrite}
						res := callSaveWithResult(cmd)
						Convey("It should update dashboard", func() {
							So(res, ShouldNotBeNil)
					...
					Convey("When updating uid to an existing uid for existing dashboard using id", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInFolder.Id, "uid": savedDashInGeneralFolder.Uid, "title": savedDashInFolder.Title}), Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
					...
					Convey("When updating existing folder to a dashboard using id", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedFolder.Id, "title": "new title"}), IsFolder: false, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
					...
					Convey("When updating existing dashboard to a folder using id", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"id": savedDashInFolder.Id, "title": "new folder title"}), IsFolder: true, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
						Convey("It should result in type mismatch error", func() {
							So(err, ShouldNotBeNil)
							So(err, ShouldEqual, models.ErrDashboardTypeMismatch)
					...
					Convey("When updating existing folder to a dashboard using uid", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedFolder.Uid, "title": "new title"}), IsFolder: false, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
						Convey("It should result in type mismatch error", func() {
							So(err, ShouldNotBeNil)
							So(err, ShouldEqual, models.ErrDashboardTypeMismatch)
					...
					Convey("When updating existing dashboard to a folder using uid", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"uid": savedDashInFolder.Uid, "title": "new folder title"}), IsFolder: true, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
						Convey("It should result in type mismatch error", func() {
							So(err, ShouldNotBeNil)
							So(err, ShouldEqual, models.ErrDashboardTypeMismatch)
					...
					Convey("When updating existing folder to a dashboard using title", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": savedFolder.Title}), IsFolder: false, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
					...
					Convey("When updating existing dashboard to a folder using title", func() {
						cmd := models.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": savedDashInGeneralFolder.Title}), IsFolder: true, Overwrite: shouldOverwrite}
						err := callSaveWithError(cmd)
...
func dashboardPermissionScenario(desc string, mock *guardian.FakeDashboardGuardian, fn dashboardPermissionScenarioFunc) {
	...
	Convey(desc, func() {
		...
		sc := &dashboardPermissionScenarioContext{dashboardGuardianMock: mock}
		defer func() {
...
func toSaveDashboardDto(cmd models.SaveDashboardCommand) dashboards.SaveDashboardDTO {
	...
	return dashboards.SaveDashboardDTO{Dashboard: dash, Message: cmd.Message, OrgId: cmd.OrgId, User: &models.SignedInUser{UserId: cmd.UserId}, Overwrite: cmd.Overwrite}
}
