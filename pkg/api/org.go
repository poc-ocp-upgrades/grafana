...
func GetOrgByName(c *m.ReqContext) Response {
	...
	org := query.Result
	result := m.OrgDetailsDTO{Id: org.Id, Name: org.Name, Address: m.Address{Address1: org.Address1, Address2: org.Address2, City: org.City, ZipCode: org.ZipCode, State: org.State, Country: org.Country}}
...
func CreateOrg(c *m.ReqContext, cmd m.CreateOrgCommand) Response {
	...
	return JSON(200, &util.DynMap{"orgId": cmd.Result.Id, "message": "Organization created"})
}
