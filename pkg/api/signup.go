...
func SignUp(c *m.ReqContext, form dtos.SignUpForm) Response {
	...
	bus.Publish(&events.SignUpStarted{Email: form.Email, Code: cmd.Code})
...
func SignUpStep2(c *m.ReqContext, form dtos.SignUpStep2Form) Response {
	...
	createUserCmd := m.CreateUserCommand{Email: form.Email, Login: form.Username, Name: form.Name, Password: form.Password, OrgName: form.OrgName}
	...
	bus.Publish(&events.SignUpCompleted{Email: user.Email, Name: user.NameOrFallback()})
