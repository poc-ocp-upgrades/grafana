...
func TestDashboardApiEndpoint(t *testing.T) {
	...
	Convey("Given a dashboard with a parent folder which does not have an acl", t, func() {
		...
		aclMockResp := []*m.DashboardAclInfoDTO{{Role: &viewerRole, Permission: m.PERMISSION_VIEW}, {Role: &editorRole, Permission: m.PERMISSION_EDIT}}
	...
	Convey("Given a dashboard with a parent folder which has an acl", t, func() {
		...
		aclMockResp := []*m.DashboardAclInfoDTO{{DashboardId: 1, Permission: m.PERMISSION_EDIT, UserId: 200}}
		bus.AddHandler("test", func(query *m.GetDashboardAclInfoListQuery) error {
			query.Result = aclMockResp
			return nil
		})
		...
		Convey("When user is an Org Viewer but has an edit permission", func() {
			role := m.ROLE_VIEWER
			mockResult := []*m.DashboardAclInfoDTO{{OrgId: 1, DashboardId: 2, UserId: 1, Permission: m.PERMISSION_EDIT}}
			bus.AddHandler("test", func(query *m.GetDashboardAclInfoListQuery) error {
		...
		Convey("When user is an Org Viewer and viewers can edit", func() {
			...
			mockResult := []*m.DashboardAclInfoDTO{{OrgId: 1, DashboardId: 2, UserId: 1, Permission: m.PERMISSION_VIEW}}
			bus.AddHandler("test", func(query *m.GetDashboardAclInfoListQuery) error {
				query.Result = mockResult
				return nil
			})
		...
		Convey("When user is an Org Viewer but has an admin permission", func() {
			role := m.ROLE_VIEWER
			mockResult := []*m.DashboardAclInfoDTO{{OrgId: 1, DashboardId: 2, UserId: 1, Permission: m.PERMISSION_ADMIN}}
			bus.AddHandler("test", func(query *m.GetDashboardAclInfoListQuery) error {
				query.Result = mockResult
				return nil
			})
	...
	Convey("Post dashboard response tests", t, func() {
		Convey("Given a correct request for creating a dashboard", func() {
			cmd := m.SaveDashboardCommand{OrgId: 1, UserId: 5, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": "Dash"}), Overwrite: true, FolderId: 3, IsFolder: false, Message: "msg"}
			mock := &dashboards.FakeDashboardService{SaveDashboardResult: &m.Dashboard{Id: 2, Uid: "uid", Title: "Dash", Slug: "dash", Version: 2}}
		...
		Convey("Given incorrect requests for creating a dashboard", func() {
			...
			}{{SaveError: m.ErrDashboardNotFound, ExpectedStatusCode: 404}, {SaveError: m.ErrFolderNotFound, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardWithSameUIDExists, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardWithSameNameInFolderExists, ExpectedStatusCode: 412}, {SaveError: m.ErrDashboardVersionMismatch, ExpectedStatusCode: 412}, {SaveError: m.ErrDashboardTitleEmpty, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardFolderCannotHaveParent, ExpectedStatusCode: 400}, {SaveError: alerting.ValidationError{Reason: "Mu"}, ExpectedStatusCode: 422}, {SaveError: m.ErrDashboardFailedGenerateUniqueUid, ExpectedStatusCode: 500}, {SaveError: m.ErrDashboardTypeMismatch, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardFolderWithSameNameAsDashboard, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardWithSameNameAsFolder, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardFolderNameExists, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardUpdateAccessDenied, ExpectedStatusCode: 403}, {SaveError: m.ErrDashboardInvalidUid, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardUidToLong, ExpectedStatusCode: 400}, {SaveError: m.ErrDashboardCannotSaveProvisionedDashboard, ExpectedStatusCode: 400}, {SaveError: m.UpdatePluginDashboardError{PluginId: "plug"}, ExpectedStatusCode: 412}}
			cmd := m.SaveDashboardCommand{OrgId: 1, Dashboard: simplejson.NewFromAny(map[string]interface{}{"title": ""})}
			for _, tc := range testCases {
				mock := &dashboards.FakeDashboardService{SaveDashboardError: tc.SaveError}
	...
	Convey("Given two dashboards being compared", t, func() {
		...
		bus.AddHandler("test", func(query *m.GetDashboardVersionQuery) error {
			query.Result = &m.DashboardVersion{Data: simplejson.NewFromAny(map[string]interface{}{"title": "Dash" + string(query.DashboardId)})}
			return nil
		})
		cmd := dtos.CalculateDiffOptions{Base: dtos.CalculateDiffTarget{DashboardId: 1, Version: 1}, New: dtos.CalculateDiffTarget{DashboardId: 2, Version: 2}, DiffType: "basic"}
