...
func TestFoldersApiEndpoint(t *testing.T) {
	...
	Convey("Create/update folder response tests", t, func() {
		Convey("Given a correct request for creating a folder", func() {
			...
			mock := &fakeFolderService{CreateFolderResult: &m.Folder{Id: 1, Uid: "uid", Title: "Folder"}}
		...
		Convey("Given a correct request for updating a folder", func() {
			cmd := m.UpdateFolderCommand{Title: "Folder upd"}
			mock := &fakeFolderService{UpdateFolderResult: &m.Folder{Id: 1, Uid: "uid", Title: "Folder upd"}}
		...
		Convey("Given incorrect requests for updating a folder", func() {
			...
			cmd := m.UpdateFolderCommand{Title: "Folder upd"}
			for _, tc := range testCases {
				mock := &fakeFolderService{UpdateFolderError: tc.Error}
