...
func TestAuthenticateUser(t *testing.T) {
	...
	Convey("Authenticate user", t, func() {
		authScenario("When a user authenticates without setting a password", func(sc *authScenarioContext) {
			...
			loginQuery := m.LoginUserQuery{Username: "user", Password: ""}
...
func authScenario(desc string, fn authScenarioFunc) {
	...
	Convey(desc, func() {
		...
		sc := &authScenarioContext{loginUserQuery: &m.LoginUserQuery{Username: "user", Password: "pwd", IpAddress: "192.168.1.1:56433"}}
		defer func() {
