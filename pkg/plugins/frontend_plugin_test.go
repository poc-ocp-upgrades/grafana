...
func TestFrontendPlugin(t *testing.T) {
	...
	Convey("When setting paths based on App on Windows", t, func() {
		...
		app := &AppPlugin{FrontendPluginBase: FrontendPluginBase{PluginBase: PluginBase{PluginDir: "c:\\grafana\\public\\app\\plugins\\app\\testdata", Id: "testdata", BaseUrl: "public/app/plugins/app/testdata"}}}
