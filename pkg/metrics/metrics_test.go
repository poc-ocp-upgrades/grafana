...
func TestMetrics(t *testing.T) {
	...
	Convey("Test send usage stats", t, func() {
		...
		bus.AddHandler("test", func(query *models.GetSystemStatsQuery) error {
			query.Result = &models.SystemStats{Dashboards: 1, Datasources: 2, Users: 3, ActiveUsers: 4, Orgs: 5, Playlists: 6, Alerts: 7, Stars: 8, Folders: 9, DashboardPermissions: 10, FolderPermissions: 11, ProvisionedDashboards: 12, Snapshots: 13, Teams: 14}
		...
		bus.AddHandler("test", func(query *models.GetDataSourceStatsQuery) error {
			query.Result = []*models.DataSourceStats{{Type: models.DS_ES, Count: 9}, {Type: models.DS_PROMETHEUS, Count: 10}, {Type: "unknown_ds", Count: 11}, {Type: "unknown_ds2", Count: 12}}
		...
		bus.AddHandler("test", func(query *models.GetAlertNotifierUsageStatsQuery) error {
			query.Result = []*models.NotifierUsageStats{{Type: "slack", Count: 1}, {Type: "webhook", Count: 2}}
		...
		oauthProviders := map[string]bool{"github": true, "gitlab": true, "google": true, "generic_oauth": true, "grafana_com": true}
